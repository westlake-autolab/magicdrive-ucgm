    ...
    for epoch in range(start_epoch, cfg_epochs):
        ...
        with tqdm(
            ...
            for step, batch in pbar:
                ...
                # == Check if we've reached 10000 steps ==
                if global_step >= 10000:
                    logger.info(f"Reached 10000 steps! Saving final checkpoint at global_step {global_step}")
                    ...
                    logger.info(f"Final checkpoint saved to {save_dir}")
                    # Exit training
                    return
